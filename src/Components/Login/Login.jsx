...
const Login = () => {
  const { loginUser, loginWithGoogle, user, setUser, loading, setLoading, dashboard, setDashboard } =
  ...
  // Function to fetch user data from API and update user state
  const fetchAndUpdateUser = async (user) => {
    try {
      ...
      // Directly set user state with fetched data
      setUser(userData);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-100 to-purple-100">
      <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-md">
        ...
        {/* Signup Link and Register Button */}
