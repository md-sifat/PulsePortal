...
const HomeCont = () => {
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="flex justify-end space-x-4">
                  ...
                  <button
                    ...
                    className={`bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-4 py-2 rounded-md hover:from-cyan-600 hover:to-blue-600 flex items-center ${
  ...
  return (
    <div className="w-full min-h-[100vh] max-h-max flex flex-col bg-gray-200">
      {/* Banner Section */}
      <section className="relative mt-10 mx-auto w-[80%] border-1 rounded-3xl">
        <Slider {...sliderSettings}>
          {successStories.map((story, index) => (
            <div key={index} className="relative h-[500px] border-1 rounded-3xl">
              <img
                src={story.image}
                alt={story.title}
              ...
              <div className="absolute inset-0 bg-transparent bg-opacity-50 flex items-center justify-center">
                ...
                >
                  ...
                  <p className="text-lg max-w-md mx-auto">{story.description}</p>
                </motion.div>
              </div>
            </div>
          ))}
