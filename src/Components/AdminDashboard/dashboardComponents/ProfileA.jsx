...
const ProfileA = () => {
    ...
    if (user?.uid) {
      const fetchProfile = async () => {
        try {
          ...
          const profileData = {
            name: data.name || 'Admin Organizer',
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Organizer Profile</h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex justify-center space-x-4">
            <button
              ...
              className={`bg-cyan-600 text-white px-6 py-2 rounded-md hover:bg-cyan-700 transition-colors duration-300 flex items-center justify-center w-24 ${
